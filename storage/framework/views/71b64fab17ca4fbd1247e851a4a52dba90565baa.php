            ...
            <div class="container-fluid">
                    ...
                    <div class="alert alert-danger mt-4">
                        ...
                        <ul>
                            <?php $__currentLoopData = session('import_errors'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $errorDetail): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <li> <a href="<?php echo e(route('clear.errors')); ?>"  class="btn btn-block btn-outline-danger">Clear Errors</a></li>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </ul>
                    </div>
                <?php endif; ?>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row mb-4">
                                <div class="col-md-6">
                                    <!-- Add More Button -->
                                    <a href="<?php echo e(route('category.create')); ?>" class="btn btn-outline-primary w-100">Add More</a>
                                </div>
                
                                <div class="col-md-6 d-flex justify-content-end">
                                    <!-- Search Form -->
                                    <form method="GET" action="<?php echo e(route('category.index')); ?>" class="d-flex w-100">
                                        <?php echo csrf_field(); ?>
                                        <input type="text" class="form-control" id="cat_name" name="cat_name" placeholder="Deals Name" aria-label="Deals Name">
                                        <input type="hidden" id="user_token" name="user_token" value="<?php echo e(Auth::user()->user_token); ?>">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-4">
                                    <div class="card shadow-sm p-3">
                                        ...
                                        <form action="<?php echo e(route('categories.import')); ?>" method="POST" enctype="multipart/form-data">
                                            <?php echo csrf_field(); ?>
                                ...
                                <div class="col-md-6 mb-4">
                                    <div class="card shadow-sm p-3">
                                        ...
                                        <?php if($paginator->isEmpty()): ?>
                                            <a href="<?php echo e(url('/deals.csv')); ?>" class="btn btn-outline-info w-100" download="deals.csv">Download Template</a>
                                        <?php else: ?>
                                            <a href="<?php echo e(url('/admin/export-categories-with-full-data')); ?>" class="btn btn-outline-info w-100" download="deals.csv">Download Full Data</a>
                                        <?php endif; ?>
                ...
                <?php else: ?>
                    <table id="datatable-buttons" class="table table-bordered dt-responsive nowrap w-100">
                        ...
                        <tbody>
                            <?php $__currentLoopData = $paginator; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td><?php echo e($loop->iteration); ?></td>
                                    <td><?php echo e($value['cat_name'] ?? 'NULL'); ?>

                                    </td>
                                    <td>
                                        <?php if(isset($value['cat_image'])): ?>
                                            <img src="<?php echo e($value['cat_image']); ?>" style="height:100px; width:100px;" onerror="this.onerror=null; this.src='<?php echo e(url('/No_Image_Available.jpg')); ?>';">
                                        <?php else: ?>
                                            No Image
                                        <?php endif; ?>
                                    </td>
                                    <td><?php echo mb_strimwidth($value['cat_description'] ?? 'NULL', 0, 200, '...'); ?></td>
                                    <td><?php echo e(isset($value['created_at']) ? date('m-d-Y h:i:s', strtotime($value['created_at'])) : 'No Date'); ?>
                    ...
                    <div class="modal-footer">
                        ...
                        <div class="modal-body" style="max-height: 400px; overflow-y: auto;">
                            ...
                            <?php $__currentLoopData = $images; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="col-md-2 mb-4 image-container" data-image="<?php echo e($image); ?>" style="position: relative;">
                                    <div class="border border-primary" style="height:100px;width:120px;margin-top: 30px; position:relative;">
                                        <img src="<?php echo e(url('/')); ?><?php echo e(Storage::url($image)); ?>" class="img-fluid" alt="Image" style="height:100px;width:120px;" onerror="this.onerror=null; this.src='<?php echo e(url('/No_Image_Available.jpg')); ?>';">
                                        ...
                                        <!-- Copy URL Button -->
                                        <input type="button" class="form-control btn btn-outline-success mt-1 mb-2" id="copy_url_<?php echo e($key); ?>" url_link="<?php echo e(url('/')); ?><?php echo e(Storage::url($image)); ?>" value="Copy URL" onclick="Copy(<?php echo e($key); ?>);" />
                                    </div>
                                </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<script>
    $(document).ready(function() {
        ...
        $('.delete-image').on('click', function() {
            ...
            $.ajax({
                url: '<?php echo e(url("/admin/delete-image")); ?>', // Your route to handle image deletion
                type: 'POST',
                data: {
...
<?php echo $__env->make('layouts.admin_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u929332160/domains/thetemz.in/public_html/medspa-giftcard/resources/views/admin/product/category_index.blade.php ENDPATH**/ ?>