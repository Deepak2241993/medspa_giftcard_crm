                                ...
                                <div class="auth-content my-auto">
                                    ...
                                    <div class="card mt-4">
                                        <div class="card-body" id="login_id">
                                            ...
                                            <form class="mt-4 mb-4 pt-2 card-body" action="<?php echo e(route('patient-login')); ?>" method="POST">
                                                <?php echo csrf_field(); ?>
                                                <!-- Email Input -->
                                                <div class="form-floating form-floating-custom mb-4">
                                                    <input type="text"
                                                        class="form-control <?php $__errorArgs = ['patient_login_id'];
...
unset($__errorArgs, $__bag); ?>"
                                                        value="<?php echo e(old('patient_login_id', request()->cookie('username'))); ?>" id="input-username"
                                                        placeholder="Enter User Name" name="patient_login_id">
                                                    <?php $__errorArgs = ['patient_login_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>"
                                                        name="password" value="<?php echo e(request()->cookie('password')); ?>" id="password-input" placeholder="Enter Password">
...
unset($__errorArgs, $__bag); ?>
                                                ...
                                                <div class="form-check mb-3">
                                                    <input type="checkbox" class="form-check-input" name="remember" id="remember" <?php echo e(request()->cookie('remember') ? 'checked' : ''); ?>>
                                                ...
                                                <a href="<?php echo e(route('forgot-password')); ?>">Forgot Password? / User Name</a>
                                            </form>
...
<?php $__env->startSection('script'); ?>
    ...
    $.ajax({
        ...
        $.ajax({
            url: '<?php echo e(route('patient-signup')); ?>',
            method: 'post',
            dataType: 'json',
            data: {
                _token: '<?php echo e(csrf_token()); ?>',
...
<?php echo $__env->make('layouts.master-without-nav', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u929332160/domains/thetemz.in/public_html/medspa-giftcard/resources/views/auth/patient_login.blade.php ENDPATH**/ ?>