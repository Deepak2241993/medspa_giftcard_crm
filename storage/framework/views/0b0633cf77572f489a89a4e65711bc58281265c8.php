                                    ...
                                    <div class="card mt-4">
                                        <div class="card-body" id="login_id">
                                            <div class="text-center">
                                                <h5 class="mb-0">Reset Password <?php echo e(session('status')); ?></h5>
                                            ...
                                            <?php endif; ?>
                                            <form class="mt-4" action="<?php echo e(route('password-reset')); ?>" method="POST">
                                            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.master-without-nav', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u929332160/domains/thetemz.in/public_html/medspa-giftcard/resources/views/auth/passwords/email.blade.php ENDPATH**/ ?>