                ...
                <div
                    ...
                    <div
                        ...
                        <p style="line-height: 24px; padding: 20px; font-size: 16px; word-wrap: break-word; font-family: arial, helvetica, sans-serif;">
                            Dear <b><?php echo e($maildata->fname . ' ' . $maildata->lname); ?></b>,<br>
                                ...
                                <table style="width: 100%; border-collapse: collapse; font-family: arial, helvetica, sans-serif;">
                                    ...
                                    <tbody>
                                        ...
                                        if($value->service_type=='unit')
                                        {
                                            ...
                                            ?>
                                            <tr>
                                                <td style="width: 25%; padding: 10px; color: #333; border: 1px solid #ccc;"><?php echo e($ServiceData->product_name); ?></td>
                                                <td style="width: 15%; padding: 10px; color: #333; border: 1px solid #ccc;">$<?php echo e($ServiceData->discounted_amount ? $ServiceData->discounted_amount : $ServiceData->amount); ?></td>
                                                <td style="width: 15%; padding: 10px; color: #333; border: 1px solid #ccc;"><?php echo e($value->qty); ?></td>
                                                <td style="width: 25%; padding: 10px; color: #333; border: 1px solid #ccc; text-align: right;">$<?php echo e($ServiceData->discounted_amount ? $value->qty*$ServiceData->discounted_amount : $value->qty*$ServiceData->amount); ?></td>
                                            </tr>
                                ...
                                <tbody>
                                    <tr style="background-color: #f0f0f0; border: 1px solid #ccc;">
                                        ...
                                        <td style="width: 50%; text-align: right; padding: 10px; color: #333; font-weight: bold; border: none;">
                                            $<?php echo e($maildata->sub_amount); ?>

                                        </td>
                                    </tr>
                        
                                    <?php if($maildata->gift_card_amount != null): ?>
                                        <?php
                                    ...
                                    <tr style="background-color: #f0f0f0; border: 1px solid #ccc;">
                                        ...
                                        <td style="width: 50%; text-align: right; padding: 10px; color: #333; border: none;">
                                            +$<?php echo e($maildata->tax_amount); ?>
                                    ...
                                    <tr style="background-color: #e0e0e0; border: 1px solid #ccc;">
                                        ...
                                        <td style="width: 50%; text-align: right; padding: 10px; color: #333; font-weight: bold; font-size: 18px; border-top: none;">
                                            $<?php echo e($maildata->final_amount); ?>
...
<?php /**PATH /home/u929332160/domains/myforevermedspa.com/public_html/resources/views/email/servicePurchaseMail.blade.php ENDPATH**/ ?>