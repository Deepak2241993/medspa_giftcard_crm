                                    ...
                                    <tbody id="data-table-body">
                                        <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <?php if($value['payment_status'] == 'succeeded'): ?>
                                                        <a href="<?php echo e(route('Resendmail_view', ['id' => $value['id']])); ?>"
                                                             class="btn btn-block btn-outline-dark" id="mailsend_<?php echo e($value['id']); ?>">Mail
                                                            Resend</a>
                                                ...
                                                <td>
                                                    ...
                                                    <?php echo $value['recipient_name'] ? $value['your_name'] : "<span class='badge bg-primary'>Self</span>"; ?>


                                                    <?php else: ?>
                                                    <span class='badge bg-warning'><?php echo Auth::user()->user_token; ?></span>
                                                    <?php endif; ?>
                                                </td>
                                                <td><?php echo e($value['recipient_name'] ? $value['recipient_name'] : $value['your_name']); ?>
                                                ...
                                                <td class="text-uppercase">
                                                    <?php echo e($value['coupon_code'] ? $value['coupon_code'] : '----'); ?></td>
                                                    ...
                                                    <?php elseif($value['payment_status'] == 'processing'): ?>
                                                        ...
                                                        <a href="#">
                                                            <span class="badge bg-warning" data-bs-toggle="modal"
                                                                ...
                                                                onclick="modalopen(<?php echo e($value['id']); ?>, '<?php echo e($value['transaction_id']); ?>')">Update
                                                                Status</span>
                                                        </a>
...
<?php echo $__env->make('layouts.admin_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u929332160/domains/thetemz.in/public_html/medspa-giftcard/resources/views/admin/cardnumber/index.blade.php ENDPATH**/ ?>