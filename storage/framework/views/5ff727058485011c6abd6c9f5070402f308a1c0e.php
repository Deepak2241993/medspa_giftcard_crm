                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a type="button"  class="btn btn-block btn-outline-success" data-bs-toggle="modal" data-bs-target="#redeem_<?php echo e($value['user_id']); ?>" onclick="modalopen(<?php echo e($value['user_id']); ?>,'<?php echo e($value['giftnumber']); ?>','<?php echo e($value['total_amount']); ?>')">
                           Redeem
                            </a> | <a type="button"  class="btn btn-block btn-outline-danger" data-bs-toggle="modal" data-bs-target="#docancel_<?php echo e($value['user_id']); ?>" onclick="docancel(<?php echo e($value['user_id']); ?>,'<?php echo e($value['giftnumber']); ?>')">
                                Do cancel
                                 </a> |
                            <?php endif; ?>
                        <a type="button"  class="btn btn-block btn-outline-primary" data-bs-toggle="modal" data-bs-target="#Statment_<?php echo e($value['user_id']); ?>" onclick="Statment(<?php echo e($value['user_id']); ?>,'<?php echo e($value['giftnumber']); ?>')">
                            View Statement</a>
...
<?php echo $__env->make('layouts.admin_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u929332160/domains/thetemz.in/public_html/medspa-giftcard/resources/views/admin/redeem/redeem_view.blade.php ENDPATH**/ ?>