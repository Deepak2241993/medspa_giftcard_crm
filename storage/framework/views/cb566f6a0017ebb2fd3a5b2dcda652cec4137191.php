...
<table width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="table-layout:fixed">
                                                                      ...
                                                                      <tr>
                                                                         <td valign="top"
                                                                            ...
                                                                            <a
                                                                               ...
                                                                               <img src="<?php echo e(url('/images/gifts/logo.png')); ?>"
                                                                                  width="150"
                                                                                  height=""
                                                                                  alt="Forever Medspa"
                                                                                  ...
                                                                                  class="CToWUd a6T"
                                                                                  data-bit="iit"
                                                                                  tabindex="0" onerror="this.onerror=null; this.src='<?php echo e(url('/No_Image_Available.jpg')); ?>';">
                                                                               <div class="a6S"
                                                                                  dir="ltr"
                                                    ...
                                                    <tbody>
                                                       <tr>
                                                          <td class="m_4043362051198468644pc-sm-fs-18 m_4043362051198468644pc-xs-fs-16"
                                                             ...
                                                             <br><img
                                                                src="<?php echo e(url('/images/gifts/logo.png')); ?>"
                                                                width="100" height="50"
                                                                class="CToWUd"
                                                                               ...
                                                                               <tbody>
                                                                                  <tr>
                                                                                     <td style="letter-spacing:-0.2px;line-height:26px;font-family:'Fira Sans',Roboto,Arial,sans-serif;font-size:16px;color:#151515;max-width:260px;overflow:hidden;text-overflow:ellipsis;word-wrap:break-word"
                                                                                        ...
                                                                                        at
                                                                                        <a href="mailto:<?php echo e($mail_data->gift_send_to); ?>"
                                                                                           target="_blank"><?php echo e($mail_data->gift_send_to); ?></a>
                                                                                        with
                                                                                        their
                                                                                        gift
                                                                                        card
                                                                                  ...
                                                                                  <tr>
                                                                                     <td valign="middle"
                                                                                        ...
                                                                                        <img src="<?php echo e(url('/images/gifts/logo.png')); ?>"
                                                                                           ...
                                                                                           class="CToWUd"
                                                                                           data-bit="iit" onerror="this.onerror=null; this.src='<?php echo e(url('/No_Image_Available.jpg')); ?>';">
                                                                                     </td>
                                                                                  </tr>
                                                                               </tbody>
                                                                            </table>
 ...
 <?php /**PATH /home/u929332160/domains/thetemz.in/public_html/medspa-giftcard/resources/views/email/receipt.blade.php ENDPATH**/ ?>