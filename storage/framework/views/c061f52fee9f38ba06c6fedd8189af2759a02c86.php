                                ...
                                <div class="auth-content my-auto">
                                    ...
                                    <div class="card mt-4">
                                        ...
                                        <?php endif; ?>
                                            ...
                                            <?php endif; ?>
                                            <form class="form-horizontal" method="POST" action="<?php echo e(route('ResetPassword')); ?>">
                                                <?php echo csrf_field(); ?>
                                                <input type="hidden" name="tokenverify" value="<?php echo e($token); ?>">
...
unset($__errorArgs, $__bag); ?>
                                            ...
                                            <div class="mt-5 text-center">
                                                <p class="text-muted mb-0">Remember It ?  <a href="<?php echo e(route('patient-login')); ?>"
...
<?php echo $__env->make('layouts.master-without-nav', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u929332160/domains/thetemz.in/public_html/medspa-giftcard/resources/views/auth/passwords/reset.blade.php ENDPATH**/ ?>