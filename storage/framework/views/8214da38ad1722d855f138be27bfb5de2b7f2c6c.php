                ...
                <td style="word-break: break-word;border-collapse: collapse !important;vertical-align: top">
                                                        ...
                                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:0px;font-family:arial,helvetica,sans-serif;"
                                                            ...
                                                            <h1 class="v-line-height v-font-size"
                                                                ...
                                                                <?php if(!empty($mail_data->recipient_name)): ?>
                                                                    <?php echo e('Received From ' . ucFirst($mail_data->your_name)); ?>

                                                                    <?php else: ?><?php echo e('Just for You'); ?>
                                                                ...
                                                                <tr>
                                                                    <td style="padding-right: 0px;padding-left: 0px;"
                                                                        ...
                                                                        <img align="center" border="0"
                                                                            src="<?php if(!empty($template_data[0]['image'])): ?> <?php echo e($template_data[0]['image']); ?><?php else: ?><?php echo e(url('/email_template/med.png')); ?> <?php endif; ?>"
                                    ...
                                    <div
                                        ...
                                        <div
                                            ...
                                            <p
                                                ...
                                                Dear <b>
                                                    <?php if(!empty($mail_data->recipient_name)): ?>
                                                        <?php echo e(ucFirst($mail_data->recipient_name)); ?>

                                                        <?php else: ?><?php echo e(ucFirst($mail_data->your_name)); ?>
                                                            ...
                                                            <div class="v-line-height v-font-size"
                                                                ...
                                                                <?php if(!empty($mail_data->recipient_name)): ?>
                                                                    <p style="line-height: 140%;padding:20px;">To
                                                                        ...
                                                                        <?php echo e(ucFirst($mail_data->your_name)); ?> has gifted
                                                                        you a voucher for your next happy session at the
                                                                        My Forever Medspa Wellness Centre.<br>
                                                                        <?php if(!empty($mail_data->recipient_name)): ?>
                                                                            <?php echo e(ucFirst($mail_data->your_name)); ?> sent
                                                                            you <?php echo e($mail_data->qty); ?> x
                                                                            $<?php echo e(round($mail_data->amount)); ?>
                                                                ...
                                                                <?php else: ?>
                                                                    ...
                                                                    <p style="line-height: 140%;padding:20px;">
                                                                        <?php echo e(ucFirst($mail_data->your_name)); ?>, at My
                                                                        ...
                                                                        Forever Medspa.
                                                                        <br>
                                                                        <?php echo e(ucFirst($mail_data->your_name)); ?> you are
                                                                        purchased <?php echo e($mail_data->qty); ?> x
                                                                        $<?php echo e(round($mail_data->amount)); ?>
                                                                                    ...
                                                                                    <tbody>
                                                                                        <tr>
                                                                                            <td style="letter-spacing:-0.2px;line-height:26px;font-family:'Fira Sans',Roboto,Arial,sans-serif;font-size:16px;color:#151515;max-width:260px;overflow:hidden;text-overflow:ellipsis;word-wrap:break-word"
                                                                                                valign="top">
                                                                                                <?php echo e($mail_data->your_name); ?>

                                                                                                <br>
                                                                                                <span
                                                                                                    style="color:#9b9b9b"><a
                                                                                                        href="mailto:<?php echo e($mail_data->receipt_email); ?>"
                                                                                                        target="_blank"><?php echo e($mail_data->receipt_email); ?></a></span>
                                                                                            </td>
                                                                                        </tr>
                                                                                    </tbody>
                                                                                </table>
                                                                                ...
                                                                                <table border="0" cellpadding="0"
                                                                                    ...
                                                                                    <tbody>
                                                                                        <tr>
                                                                                            <td style="letter-spacing:-0.2px;line-height:26px;font-family:'Fira Sans',Roboto,Arial,sans-serif;font-size:16px;color:#151515;max-width:260px;overflow:hidden;text-overflow:ellipsis;word-wrap:break-word"
                                                                                                valign="top">
                                                                                                <?php echo e($mail_data->recipient_name); ?>

                                                                                                <br>
                                                                                                <span
                                                                                                    style="color:#9b9b9b"><a
                                                                                                        href="mailto:<?php echo e($mail_data->gift_send_to); ?>"
                                                                                                        target="_blank"><?php echo e($mail_data->gift_send_to); ?></a></span>
                                                                                            </td>
                                                                                        </tr>
                                                                                    </tbody>
                                                                                </table>
                                                    ...
                                                    <tr>
                                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:30px 0px 0px;font-family:arial,helvetica,sans-serif;"
                                                            ...
                                                            <div style="text-align: center; margin-top: 20px;">
                                                                <a href="<?php echo e(route('patient-login')); ?>" target="_blank" 
                    ...
                    <?php $__currentLoopData = $cardnumber; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="u-row-container"
                            style="padding: 36px 0px;background-image: url('<?php echo e(url('/email_template')); ?>/1695808724401-Rectangle%202%20copy%202.png');background-repeat: no-repeat;background-position: center center;background-color: transparent">
                            <div class="u-row"
                                style="margin: 0 auto;min-width: 320px;max-width: 600px;overflow-wrap: break-word;word-wrap: break-word;word-break: break-word;background-color: transparent;">
                                <div
                                    style="border-collapse: collapse;display: table;width: 100%;height: 100%;background-color: transparent;">
                                                                ...
                                                                <div align="center">
                                                                    ...
                                                                    <span
                                                                        ...
                                                                        style="display:block;padding:10px 20px;line-height:120%; box-sizing: border-box;display: inline-block;text-decoration: none;-webkit-text-size-adjust: none;text-align: center;color: #FFFFFF; background-color: #fca52a; border-radius: 4px;-webkit-border-radius: 4px; -moz-border-radius: 4px; width:45%; max-width:100%; overflow-wrap: break-word; word-break: break-word; word-wrap:break-word; mso-border-alt: none;font-size: 21px;"><span
                                                                            style="line-height: 25.2px;"><?php echo e($value->giftnumber); ?></span></span>
                                                                                                ...
                                                                                                <tr
                                                                                                    ...
                                                                                                    <td align="left"
                                                                                                        ...
                                                                                                        <a href="https://www.facebook.com/ForeverMedSpaNJ/"
                                                                                                            title="Facebook"
                                                                                                            target="_blank">
                                                                                                            <img src="<?php echo e(url('/')); ?>/email_template/facebook.png"
                                                                                                                alt="Facebook"
                                                                                                                title="Facebook"
                                                                                                                width="32"
                                                                                                                style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: block !important;border: none;height: auto;float: none;max-width: 32px !important" onerror="this.onerror=null; this.src='<?php echo e(url('/No_Image_Available.jpg')); ?>';">
                                                                                                        </a>
                                                                                                    </td>
                                                                                                </tr>
                                                                                            </tbody>
                                                                                                ...
                                                                                                <tr
                                                                                                    ...
                                                                                                    <td align="left"
                                                                                                        ...
                                                                                                        <a href="https://x.com/ForeverMedSpaNJ"
                                                                                                            title="Twitter"
                                                                                                            target="_blank">
                                                                                                            <img src="<?php echo e(url('/')); ?>/email_template/twitter.png"
                                                                                                                alt="Twitter"
                                                                                                                title="Twitter"
                                                                                                                width="32"
                                                                                                                style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: block !important;border: none;height: auto;float: none;max-width: 32px !important" onerror="this.onerror=null; this.src='<?php echo e(url('/No_Image_Available.jpg')); ?>';">
                                                                                                ...
                                                                                                <tr
                                                                                                    ...
                                                                                                    <td align="left"
                                                                                                        ...
                                                                                                        <a href="https://www.instagram.com/forevermedspa/?hl=en"
                                                                                                            title="Instagram"
                                                                                                            target="_blank">
                                                                                                            <img src="<?php echo e(url('/')); ?>/email_template/instagram.png"
                                                                                                                alt="Instagram"
                                                                                                                title="Instagram"
                                                                                                                width="32"
                                                                                                                style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: block !important;border: none;height: auto;float: none;max-width: 32px !important" onerror="this.onerror=null; this.src='<?php echo e(url('/No_Image_Available.jpg')); ?>';">
...
<?php /**PATH /home/u929332160/domains/thetemz.in/public_html/medspa-giftcard/resources/views/email/giftcard.blade.php ENDPATH**/ ?>