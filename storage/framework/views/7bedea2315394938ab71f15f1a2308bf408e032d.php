...
<div id=":18p" class="a3s aiL msg-1377519352946152473">
    ...
    <div bgcolor="#f5f7fb">
                                                                        ...
                                                                        <tr>
                                                                            <td class="m_-1377519352946152473content"
                                                                                ...
                                                                                <p style="margin:0 0 1em">Dear
                                                                                    <?php echo e($gifcardCancelData['receiverAndSenderDetails']['your_name']); ?>,
                                                                                </p>
                                                                                <p>As per your request, the Giftcard
                                                                                    with serial number :
                                                                                    <?php echo e($gifcardCancelData['result'][0]['giftnumber']); ?>
                                                                                ...
                                                                                <table border="1" cellspacing="0"
                                                                                    ...
                                                                                    <?php $__currentLoopData = $gifcardCancelData['result']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                                        <tr>
                                                                                            ...
                                                                                            <td><?php echo e($item['transaction_id']); ?>

                                                                                            </td>
                                                                                            <td><?php echo e($item['giftnumber']); ?>

                                                                                            </td>
                                                                                            <td><?php echo e(date('m-d-Y', strtotime($item['updated_at']))); ?>

                                                                                            </td>
                                                                                            <td><?php echo e($item['comments']); ?>

                                                                                            </td>
                                                                                            <td><?php echo e($item['actual_paid_amount']); ?>
                                                                                    ...
                                                                                    <tr>
                                                                                        ...
                                                                                        <td><?php echo e($gifcardCancelData['actual_paid_amount']); ?>
        ...
        <img alt="" src="<?php echo e(url('/images/gifts/logo.png')); ?>"
...
<?php /**PATH /home/u929332160/domains/thetemz.in/public_html/medspa-giftcard/resources/views/email/GiftCardCancel.blade.php ENDPATH**/ ?>