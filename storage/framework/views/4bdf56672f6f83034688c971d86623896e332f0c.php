                        ...
                        <div class="row">
                            <div class="col-md-12 mx-0">
                                ...
                                <form id="msform" class="some_one_else_div" Method="post"
                                    action="<?php echo e(route('giftcard-purchase')); ?>">
                                    <?php echo csrf_field(); ?>
                                    <!-- progressbar -->
                                    <ul id="progressbar">
    ...
    function setupAutocomplete(inputField) {
        $(inputField).autocomplete({
            source: function (request, response) {
                $.ajax({
                    url: "<?php echo e(route('email-suggestions')); ?>", // Laravel route to fetch emails
                    type: "GET",
                    data: {
                        query: request.term
                    },
...
$(document).ready(function () {
    function setupAutocomplete(inputField) {
        $(inputField).autocomplete({
            source: function (request, response) {
                $.ajax({
                    url: "<?php echo e(route('name-suggestions')); ?>", // Laravel route
                    type: "GET",
                    data: {
                        query: request.term
                    },
...
<?php echo $__env->make('layouts.admin_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u929332160/domains/thetemz.in/public_html/medspa-giftcard/resources/views/gift/gift_sale.blade.php ENDPATH**/ ?>