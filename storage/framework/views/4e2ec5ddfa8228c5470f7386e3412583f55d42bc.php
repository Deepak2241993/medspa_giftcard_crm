                ...
                <div class="card shadow-sm">
                    ...
                    <div class="card-body">
                        <div class="row align-items-end">
                            ...
                            <!-- Add More Button -->
                            <div class="col-md-4">
                                <a href="<?php echo e(route('product.create')); ?>" class="btn btn-dark w-100">Add More</a>
                            </div>
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.admin_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u929332160/domains/thetemz.in/public_html/medspa-giftcard/resources/views/admin/product/product_index.blade.php ENDPATH**/ ?>