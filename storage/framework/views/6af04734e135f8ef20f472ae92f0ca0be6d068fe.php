                                                                        ...
                                                                        <tr>
                                                                            <td class="m_-1377519352946152473content"
                                                                                ...
                                                                                <p style="margin:0 0 1em">Dear
                                                                                    <?php echo e($statement['giftCardHolderDetails']['recipient_name'] ? $statement['giftCardHolderDetails']['recipient_name'] : $statement['giftCardHolderDetails']['your_name']); ?>,
                                                                                </p>
                                                                                <p>We’ve attached your latest Giftcard
                                                                                    Redeem Statement. You’ll be able to
                                                                                    see the summary of transactions made
                                                                                    for the giftcard
                                                                                    <?php echo e($statement['result'][0]['giftnumber']); ?>.
                                                                                </p>
                                                                                <table border="1" cellspacing="0"
                                                                                    ...
                                                                                    <?php $__currentLoopData = $statement['result']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                                        <tr style="background-color: #f2f2f2;">
                                                                                            <td style="padding: 10px;"><?php echo e($key + 1); ?></td>
                                                                                            <td style="padding: 10px;"><?php echo e($item['transaction_id']); ?></td>
                                                                                            <td style="padding: 10px;"><?php echo e($item['giftnumber']); ?></td>
                                                                                            <td style="padding: 10px;"><?php echo e(date('m-d-Y', strtotime($item['updated_at']))); ?></td>
                                                                                            <td style="padding: 10px;"><?php echo e($item['comments']); ?></td>
                                                                                            <td style="padding: 10px;">$<?php echo e($item['amount']); ?></td>
                                                                                        </tr>
                                                                                    ...
                                                                                    <tr>
                                                                                        <td colspan="4"></td>
                                                                                        <th>Total Amount</th>
                                                                                        <td>$<?php echo e($statement['TotalAmount']); ?></td>
                                                                                    </tr>
                                                                                </table>
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    <tr>
                                                                        <td
                                                                            ...
                                                                            ⓒ <?php echo e(date('Y')); ?> Forever MedSpa
...
<?php /**PATH /home/u929332160/domains/thetemz.in/public_html/medspa-giftcard/resources/views/email/Giftstatement.blade.php ENDPATH**/ ?>