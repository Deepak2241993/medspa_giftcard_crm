...
<html lang="en">
	...
	<head>
		...
		<title>Home V.1 - Medicia</title>
		<link rel="shortcut icon" href="{{url('/front_new')}}/assets/images/logo/favourite_icon_2.png">

		<!-- css include -->
		<link rel="stylesheet" type="text/css" href="{{url('/front_new')}}/assets/css/bootstrap.min.css">
		<link rel="stylesheet" type="text/css" href="{{url('/front_new')}}/assets/css/line-awesome.min.css">
		<link rel="stylesheet" type="text/css" href="{{url('/front_new')}}/assets/css/owl.carousel.min.css">
		<link rel="stylesheet" type="text/css" href="{{url('/front_new')}}/assets/css/magnific-popup.css">
		<link rel="stylesheet" type="text/css" href="{{url('/front_new')}}/assets/css/jquery-ui.css">
		<!-- custom - css include -->
		<link rel="stylesheet" type="text/css" href="{{url('/front_new')}}/assets/css/style.css">
	...
	<body class="home-v1">
						...
						<div class="col-lg-3 col-md-12 col-sm-12 col-xs-12">
							<div class="brand-logo clearfix">
								<a href="index.html" class="brand-link">
									<img src="{{url('/front_new')}}/assets/images/logo/logo_2.png" alt="logo_not_found">
								</a>
												...
												<div class="col-lg-3">
													<div class="promotion-fullimage clearfix">
														<a href="#!" class="item-image">
															<img src="{{url('/front_new')}}/assets/images/promotion/img_8.jpg" alt="image_not_found">
														</a>
										...
										<div aria-labelledby="user-dropdown" class="user-dropdown dropdown-menu ul-li-block clearfix">
											<div class="profile-info clearfix">
												<a href="#!" class="user-thumbnail">
													<img src="{{url('/front_new')}}/assets/images/meta/img_2.png" alt="thumbnail_not_found">
												</a>
												...
												<ul class="clearfix">
													<li>
														<div class="item-image">
															<img src="{{url('/front_new')}}/assets/images/cart/img_1.png" alt="image_not_found">
														</div>
													...
													<li>
														<div class="item-image">
															<img src="{{url('/front_new')}}/assets/images/cart/img_2.png" alt="image_not_found">
														</div>
														<div class="item-content">
													...
													<li>
														<div class="item-image">
															<img src="{{url('/front_new')}}/assets/images/cart/img_3.png" alt="image_not_found">
														</div>
														<div class="item-content">
		...
		<div class="sidebar-menu-wrapper">
			<div id="sidebar-menu" class="sidebar-menu">
				...
				<div class="brand-logo text-center clearfix">
					<a href="index.html" class="brand-link">
						<img src="{{url('/front_new')}}/assets/images/logo/logo_3.png" alt="logo_not_found">
					</a>
				</div>
		...
		<main>
			...
			<section id="slider-section" class="slider-section clearfix">
				<div id="main-carousel" class="main-carousel arrow-right-left owl-carousel owl-theme">
					...
					<div class="item d-flex align-items-center" data-background="{{url('/front_new')}}/assets/images/slider/bg_1.jpg">
						<div class="container">
					...
					<div class="item d-flex align-items-center" data-background="{{url('/front_new')}}/assets/images/slider/bg_3.jpg">
						<div class="container">
							<div class="row justify-content-lg-start justify-content-md-center">
								<div class="col-lg-7 col-md-9 col-sm-12 col-xs-12">
									<div class="slider-content">
					...
					<div class="item d-flex align-items-center" data-background="{{url('/front_new')}}/assets/images/slider/bg_4.jpg">
						<div class="container">
			...
			<section id="promotion-section" class="promotion-section sec-ptb-100 pb-0 decoration-wrap clearfix">
				<div class="container">
					<div class="masonry-grid">
						...
						<div class="grid-item">
							<div class="promotion-fullimage clearfix">
								<a href="#!" class="item-image">
									<img src="{{url('/front_new')}}/assets/images/promotion/img_1.jpg" alt="image_not_found">
								</a>
						...
						<div class="grid-item w-66">
							<div class="promotion-fullimage clearfix">
								<a href="#!" class="item-image">
									<img src="{{url('/front_new')}}/assets/images/promotion/img_2.jpg" alt="image_not_found">
								</a>
						...
						<div class="grid-item">
							<div class="promotion-fullimage clearfix">
								<a href="#!" class="item-image">
									<img src="{{url('/front_new')}}/assets/images/promotion/img_3.jpg" alt="image_not_found">
								</a>
								<div class="promotion-content position-bottom text-right">
									<h3 class="item-title">
						...
						<div class="grid-item">
							<div class="promotion-fullimage clearfix">
								<a href="#!" class="item-image">
									<img src="{{url('/front_new')}}/assets/images/promotion/img_4.jpg" alt="image_not_found">
								</a>
				...
				<span class="decoration-image pill-image-1">
					<img src="{{url('/front_new')}}/assets/images/decoration/pill_1.png" alt="pill_image_not_found">
				</span>
			</section>
			...
			<section class="shop-section sec-ptb-100 decoration-wrap clearfix">
							...
							<div class="row justify-content-center mb-70">
									...
									<div class="product-grid text-center clearfix">
										<div class="item-image">
											<a href="shop-details-1.html" class="image-wrap">
												<img src="{{url('/front_new')}}/assets/images/product/img_1.jpg" alt="image_not_found">
											</a>
								...
								<div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
									<div class="product-grid text-center clearfix">
										<div class="item-image">
											<a href="shop-details-1.html" class="image-wrap">
												<img src="{{url('/front_new')}}/assets/images/product/img_2.jpg" alt="image_not_found">
											</a>
											<div class="btns-group ul-li-center clearfix">
												<ul class="clearfix">
													<li><a href="#!" data-toggle="tooltip" data-placement="top" title="Add To Cart"><i class="las la-shopping-basket"></i></a></li>
								...
								<div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
									<div class="product-grid text-center clearfix">
										<div class="item-image">
											<a href="shop-details-1.html" class="image-wrap">
												<img src="{{url('/front_new')}}/assets/images/product/img_3.jpg" alt="image_not_found">
											</a>
											<div class="post-label ul-li-right clearfix">
												<ul class="clearfix">
								...
								<div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
									<div class="product-grid text-center clearfix">
										<div class="item-image">
											<a href="shop-details-1.html" class="image-wrap">
												<img src="{{url('/front_new')}}/assets/images/product/img_4.jpg" alt="image_not_found">
											</a>
											<div class="btns-group ul-li-center clearfix">
												<ul class="clearfix">
													<li><a href="#!" data-toggle="tooltip" data-placement="top" title="Add To Cart"><i class="las la-shopping-basket"></i></a></li>
								...
								<div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
									<div class="product-grid text-center clearfix">
										<div class="item-image">
											<a href="shop-details-1.html" class="image-wrap">
												<img src="{{url('/front_new')}}/assets/images/product/img_5.jpg" alt="image_not_found">
											</a>
											<div class="post-label ul-li-right clearfix">
												<ul class="clearfix">
													<li class="bg-skyblue">-19%</li>
								...
								<div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
									<div class="product-grid text-center clearfix">
										<div class="item-image">
											<a href="shop-details-1.html" class="image-wrap">
												<img src="{{url('/front_new')}}/assets/images/product/img_6.jpg" alt="image_not_found">
											</a>
											<div class="post-label ul-li-right clearfix">
												<ul class="clearfix">
								...
								<div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
									<div class="product-grid text-center clearfix">
										<div class="item-image">
											<a href="shop-details-1.html" class="image-wrap">
												<img src="{{url('/front_new')}}/assets/images/product/img_7.jpg" alt="image_not_found">
											</a>
											<div class="btns-group ul-li-center clearfix">
												<ul class="clearfix">
													<li><a href="#!" data-toggle="tooltip" data-placement="top" title="Add To Cart"><i class="las la-shopping-basket"></i></a></li>
								...
								<div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
									<div class="product-grid text-center clearfix">
										<div class="item-image">
											<a href="shop-details-1.html" class="image-wrap">
												<img src="{{url('/front_new')}}/assets/images/product/img_8.jpg" alt="image_not_found">
											</a>
				...
				<span class="decoration-image pill-image-1">
					<img src="{{url('/front_new')}}/assets/images/decoration/pill_2.png" alt="pill_image_not_found">
				</span>
			</section>
			...
			<div class="quickview-modal modal fade" id="quickview-modal" tabindex="-1" role="dialog" aria-hidden="true">
				<div class="modal-dialog modal-dialog-centered" role="document">
					<div class="modal-content clearfix">
						...
						<div class="item-image">
							<img src="{{url('/front_new')}}/assets/images/product/img_12.jpg" alt="image_not_found">
						</div>
						<div class="item-content">
				...
				<div class="wrap-1600 sec-ptb-100 bg-gray decoration-wrap clearfix">
					<div class="container">
						<div class="offer-item clearfix">
							<div class="row align-items-center justify-content-lg-between justify-content-md-center justify-content-sm-center">
								...
								<div class="col-lg-5 col-md-7 col-sm-10 col-xs-12 order-last">
									<div class="item-image">
										<img src="{{url('/front_new')}}/assets/images/offer/img_1.png" alt="image_not_found">
									</div>
								</div>
						...
						<span class="decoration-image leaf-image-1">
							<img src="{{url('/front_new')}}/assets/images/decoration/leaf_1.png" alt="leaf_image_not_found">
						</span>
			...
			<section id="blog-section" class="blog-section sec-ptb-100 clearfix">
				<div class="container">
					...
					<div class="row justify-content-lg-between justify-content-md-center justify-content-sm-center">
						<div class="col-lg-4 col-md-12 col-sm-12 col-xs-12">
							<div class="blog-boxed" data-background="{{url('/front_new')}}/assets/images/blog/img_1.jpg">
								<div class="post-admin clearfix">
									<div class="admin-image">
										<img src="{{url('/front_new')}}/assets/images/meta/img_1.png" alt="image_not_found">
									</div>
						...
						<div class="col-lg-4 col-md-12 col-sm-12 col-xs-12">
							<div class="blog-boxed" data-background="{{url('/front_new')}}/assets/images/blog/img_1.jpg">
								<div class="post-admin clearfix">
									<div class="admin-image">
										<img src="{{url('/front_new')}}/assets/images/meta/img_2.png" alt="image_not_found">
									</div>
									<div class="admin-content">
						...
						<div class="col-lg-4 col-md-12 col-sm-12 col-xs-12">
							<div class="blog-boxed" data-background="{{url('/front_new')}}/assets/images/blog/img_1.jpg">
								<div class="post-admin clearfix">
									<div class="admin-image">
										<img src="{{url('/front_new')}}/assets/images/meta/img_3.png" alt="image_not_found">
									</div>
									<div class="admin-content">
					...
					<div class="brand-carousel mt--40 owl-carousel owl-theme">
						...
						<div class="item">
							<a class="brand-logo" href="#!">
								<img src="{{url('/front_new')}}/assets/images/brand/img_1.png" alt="logo_not_found">
							</a>
						</div>

						<div class="item">
							<a class="brand-logo" href="#!">
								<img src="{{url('/front_new')}}/assets/images/brand/img_2.png" alt="logo_not_found">
							</a>
						</div>

						<div class="item">
							<a class="brand-logo" href="#!">
								<img src="{{url('/front_new')}}/assets/images/brand/img_3.png" alt="logo_not_found">
							</a>
						</div>

						<div class="item">
							<a class="brand-logo" href="#!">
								<img src="{{url('/front_new')}}/assets/images/brand/img_4.png" alt="logo_not_found">
							</a>
						</div>

						<div class="item">
							<a class="brand-logo" href="#!">
								<img src="{{url('/front_new')}}/assets/images/brand/img_5.png" alt="logo_not_found">
							</a>
						</div>

						<div class="item">
							<a class="brand-logo" href="#!">
								<img src="{{url('/front_new')}}/assets/images/brand/img_6.png" alt="logo_not_found">
							</a>
						</div>
				...
				<div class="wrapper clearfix">
					...
					<div class="row zoom-gallery justify-content-lg-between justify-content-md-center justify-content-sm-center">
						<div class="col-lg-2 col-md-3 col-sm-4 col-xs-12 col-6">
							<a class="popup-image instagram-shoot" href="{{url('/front_new')}}/assets/images/instagram/img_1.jpg">
								<img src="{{url('/front_new')}}/assets/images/instagram/img_1.jpg" alt="image_not_found">
						...
						<div class="col-lg-2 col-md-3 col-sm-4 col-xs-12 col-6">
							<a class="popup-image instagram-shoot" href="{{url('/front_new')}}/assets/images/instagram/img_2.jpg">
								<img src="{{url('/front_new')}}/assets/images/instagram/img_2.jpg" alt="image_not_found">
								<span class="instagram-icon">
									<i class="lab la-instagram"></i>
								</span>
							</a>
						...
						<div class="col-lg-2 col-md-3 col-sm-4 col-xs-12 col-6">
							<a class="popup-image instagram-shoot" href="{{url('/front_new')}}/assets/images/instagram/img_3.jpg">
								<img src="{{url('/front_new')}}/assets/images/instagram/img_3.jpg" alt="image_not_found">
								<span class="instagram-icon">
									<i class="lab la-instagram"></i>
								</span>
							</a>
						...
						<div class="col-lg-2 col-md-3 col-sm-4 col-xs-12 col-6">
							<a class="popup-image instagram-shoot" href="{{url('/front_new')}}/assets/images/instagram/img_4.jpg">
								<img src="{{url('/front_new')}}/assets/images/instagram/img_4.jpg" alt="image_not_found">
								<span class="instagram-icon">
									<i class="lab la-instagram"></i>
								</span>
							</a>
						...
						<div class="col-lg-2 col-md-3 col-sm-4 col-xs-12 col-6">
							<a class="popup-image instagram-shoot" href="{{url('/front_new')}}/assets/images/instagram/img_5.jpg">
								<img src="{{url('/front_new')}}/assets/images/instagram/img_5.jpg" alt="image_not_found">
								<span class="instagram-icon">
									<i class="lab la-instagram"></i>
								</span>
							</a>
						...
						<div class="col-lg-2 col-md-3 col-sm-4 col-xs-12 col-6">
							<a class="popup-image instagram-shoot" href="{{url('/front_new')}}/assets/images/instagram/img_6.jpg">
								<img src="{{url('/front_new')}}/assets/images/instagram/img_6.jpg" alt="image_not_found">
								<span class="instagram-icon">
									<i class="lab la-instagram"></i>
								</span>
							</a>
		...
		<footer id="footer-section" class="footer-section pb-30 clearfix">
			<div class="container">
						...
						<div class="col-lg-4 col-md-12 col-sm-12 col-xs-12">
							<div class="about-content">
								<div class="brand-logo mb-4 clearfix">
									<a href="index.html" class="brand-link">
										<img src="{{url('/front_new')}}/assets/images/logo/medicia_2.png" alt="logo_not_found">
									</a>
								</div>
								<p class="mb-30">
						...
						<div class="col-lg-3 col-md-4 col-sm-12 col-xs-12">
							<div class="payment-cards ul-li mb-30 clearfix">
								...
								<ul class="mb-3 clearfix">
									<li><a href="#!"><img src="{{url('/front_new')}}/assets/images/payment_card/card_1.png" alt="_not_found"></a></li>
									<li><a href="#!"><img src="{{url('/front_new')}}/assets/images/payment_card/card_2.png" alt="_not_found"></a></li>
									<li><a href="#!"><img src="{{url('/front_new')}}/assets/images/payment_card/card_3.png" alt="_not_found"></a></li>
									<li><a href="#!"><img src="{{url('/front_new')}}/assets/images/payment_card/card_4.png" alt="_not_found"></a></li>
									<li><a href="#!"><img src="{{url('/front_new')}}/assets/images/payment_card/card_5.png" alt="_not_found"></a></li>
								</ul>
				...
				<div class="footer-bottom bg-gray text-center clearfix">
					...
					<span class="decoration-image pill-image-1">
						<img src="{{url('/front_new')}}/assets/images/decoration/pill_3.png" alt="pill_image_not_found">
					</span>
				</div>
		...
		<!-- jquery include -->
		<script src="{{url('/front_new')}}/assets/js/jquery-3.4.1.min.js"></script>
		<script src="{{url('/front_new')}}/assets/js/jquery-ui.js"></script>
		<script src="{{url('/front_new')}}/assets/js/popper.min.js"></script>
		<script src="{{url('/front_new')}}/assets/js/bootstrap.min.js"></script>
		<script src="{{url('/front_new')}}/assets/js/magnific-popup.min.js"></script>
		<script src="{{url('/front_new')}}/assets/js/owl.carousel.min.js"></script>
		<script src="{{url('/front_new')}}/assets/js/owl.carousel2.thumbs.min.js"></script>
		<script src="{{url('/front_new')}}/assets/js/isotope.pkgd.min.js"></script>
		<script src="{{url('/front_new')}}/assets/js/masonry.pkgd.min.js"></script>
		<script src="{{url('/front_new')}}/assets/js/imagesloaded.pkgd.min.js"></script>
		<script src="{{url('/front_new')}}/assets/js/countdown.js"></script>

		<!-- google map - jquery include -->
        <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDk2HrmqE4sWSei0XdKGbOMOHN3Mm2Bf-M&ver=2.1.6"></script>
        <script src="{{url('/front_new')}}/assets/js/gmaps.min.js"></script>

		<!-- mobile menu - jquery include -->
        <script src="{{url('/front_new')}}/assets/js/mCustomScrollbar.js"></script>

		<!-- custom - jquery include -->
		<script src="{{url('/front_new')}}/assets/js/custom.js"></script>
